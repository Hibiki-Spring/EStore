...
<body>
	...
	<div class="container4">
		<div class="register_box">
			...
			<div class="security">
				<form action="UpdateUserInfoSer">
    				<ul class="list">
    					<li>
    						<input id="J_euserName" class="long" readonly="readonly" name="name" value="${sessionScope.user.username}" type="text" />
    					...
    					<%-- <li>
    						<input id="J_euserName" class="long" name="password" value="${sessionScope.user.password}" type="password" />
